	...
	<header>
		<div class="header-homepage">
			...
			<div class="menu-items-box">
				<a href="<?php echo base_url();?>HomePage"><span> TRANG CHỦ </span></a>
			...
			<div class="menu-user-cart">
				<a href="<?php echo base_url();?>LoginPage">
			...
			<?php endif ?>
				<a href="<?php echo base_url();?>CartPage">
		...
		<div class="grid wide">
			...
			<div class="menu-container">
				...
				<?php foreach ($arLoaiao as $key => $value): ?>
					<a href="<?php echo base_url();?>HomePage/IDLOAI/<?php echo $value['idloaiao'] ?>"><span><?php echo $value['tenloaiao'] ?></span></a>
				<?php endforeach ?>
			</div>
